...
"""
The patients were tested thrice before the oncologist concluded that they had cancer.
The general belief is that 1.48 out of a 1000 people have breast cancer in the US at that particular time
when this test was conducted. The patients were tested over multiple tests.
Three sets of test were done and the patient was only diagnosed with cancer
if she tested positive in all three of them. True positive Rate – 93% True negative Rate – 99%
"""
