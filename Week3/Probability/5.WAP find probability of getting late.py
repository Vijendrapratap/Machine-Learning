"""In my town, it's rainy one third of the days. Given that it is rainy, there will be heavy traffic with
 ...
 In other situations (rainy and no traffic, not rainy and traffic) the probability of being late is 0.250.
...
prob_rain = 1/3
prob_not_rain = 2/3
prob_traffic_rain = 1/2
prob_traffic_no_rain = 1/4
prob_rain_tarffic_late = 1/2
prob_not_rain_no_traffic_late = 1/8
prob_rain_no_traffic_late = prob_no_rain_traffic_late = 0.25

prob1 = prob_not_rain * prob_traffic_no_rain * (1-prob_traffic_no_rain)
print("it's not raining and there is heavy traffic and I am not late",prob1)


prob2 = prob_rain_tarffic_late + prob_no_rain_traffic_late + prob_rain_no_traffic_late + prob_not_rain_no_traffic_late
print("probability that I am late",prob2)

prob_rain_and_late = prob_rain_no_traffic_late + prob_rain_tarffic_late

prob3 = prob_rain_and_late / prob_rain_tarffic_late
